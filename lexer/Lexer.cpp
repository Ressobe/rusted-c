...
void Lexer::createNumberToken() {
    ...
    while (!this->src.empty() && (std::isdigit(this->peek()) || this->peek() == '.' )) {
...
void Lexer::createCompareToken(std::string firstChar, std::string secondChar, TokenType firstToken, TokenType secondToken) {
          ...
          createIdentifierToken();
            ...
            switch (currentChar) {
                ...
                case '<':
                    ...
                    break;
                case '>':
                    createCompareToken(">", "=", TokenType::GreaterEqual, TokenType::GreaterThan);
                    break;
                case '"': 
